...
def test_create_lookup_tables(create_lookup_tables):
    ...
    assert len(vocab_to_int) == len(int_to_vocab),        'Length of vocab_to_int and int_to_vocab don\'t match. '         'vocab_to_int is length {}. int_to_vocab is length {}'.format(len(vocab_to_int), len(int_to_vocab))
    ...
    assert not (vocab_to_int_word_set - int_to_vocab_word_set),    'vocab_to_int and int_to_vocab don\'t have the same words.'         '{} found in vocab_to_int, but not in int_to_vocab'.format(vocab_to_int_word_set - int_to_vocab_word_set)
    assert not (int_to_vocab_word_set - vocab_to_int_word_set),        'vocab_to_int and int_to_vocab don\'t have the same words.'         '{} found in int_to_vocab, but not in vocab_to_int'.format(int_to_vocab_word_set - vocab_to_int_word_set)
    ...
    assert not (vocab_to_int_word_id_set - int_to_vocab_word_id_set),        'vocab_to_int and int_to_vocab don\'t contain the same word ids.'         '{} found in vocab_to_int, but not in int_to_vocab'.format(vocab_to_int_word_id_set - int_to_vocab_word_id_set)
    assert not (int_to_vocab_word_id_set - vocab_to_int_word_id_set),        'vocab_to_int and int_to_vocab don\'t contain the same word ids.'         '{} found in int_to_vocab, but not in vocab_to_int'.format(int_to_vocab_word_id_set - vocab_to_int_word_id_set)
    
    # Make sure the dicts make the same lookup
    missmatches = [(word, id, id, int_to_vocab[id]) for word, id in vocab_to_int.items() if int_to_vocab[id] != word]
    
    assert not missmatches,        'Found {} missmatche(s). First missmatch: vocab_to_int[{}] = {} and int_to_vocab[{}] = {}'.format(len(missmatches),
                                                                                                          *missmatches[0])
